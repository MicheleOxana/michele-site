...
export default function Servicos() {
  const itens: Item[] = [
    { 
      ...
      preco: 300, 
      descricao: 'Seu próprio assistente virtual para o Discord, preparado para interagir com seus seguidores e gerenciar sua comunidade durante suas transmissões.',
      detalhes: 'Comandos personalizados para interação no chat. Automação de mensagens e comandos de moderação. Notificações de live automáticas para seu Discord. Reações criativas para engajar seus seguidores.',
      key: 'botDiscord'
    },
    { 
      nome: 'Bot para Servidores de GTA RP, RDR RP ou Minecraft 🚗💥', 
      preco: 400, 
      descricao: 'Aumente a diversão do seu servidor com bots personalizados para GTA RP, RDR RP ou Minecraft. Com comandos exclusivos, eventos automatizados e integração com a comunidade.',
      detalhes: 'Sistema de economia para RP. Missões e eventos automáticos para engajar os jogadores. Comandos personalizados para interações específicas do servidor. Integração com Discord para avisos e interações de chat.',
      key: 'botRP'
    },
    { 
      ...
      detalhes: 'Integração com Twitch para eventos de subs, bits e raides. Comandos personalizados no Discord para interação com seus seguidores. Sistema de ranking e pontos entre Discord e Twitch. Notificações automáticas de live e eventos.',
          ...
          {itens.map(({ nome, preco, descricao, detalhes, key }) => (
            <div key={key} className="bg-purple-950/70 border border-fuchsia-700 rounded-2xl p-6 shadow-lg shadow-fuchsia-900 flex flex-col justify-between">
              ...
              <div className="mt-4 space-x-4">
                ...
                <a
                  href="mailto:contato@micheleoxana.com?subject=Interessado no Serviço"
